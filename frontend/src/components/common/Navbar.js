      ...
      <nav className="navbar is-dark">
        ...
        <div className="container">
          <div className="navbar-brand">
            <Link to="" className="logo-button" ><img className="logo-picture" src={require('../../assets/dumbbell.png')} alt="logo"/>Spot.me</Link>
            <Link to="/" className="navbar-item"></Link>
          </div>
          <div className="navbar-menu">
            <div className="navbar-end">
            {isAuthenticated() && <Link to="" className="navbar-button"><img src={require('../../assets/color.png')} alt="home" /></Link>}
